...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateDeviceDTO :  IEquatable<CreateDeviceDTO>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateDeviceDTO" /> class.
        /// </summary>
        /// <param name="DeviceDescription">DeviceDescription.</param>
        /// <param name="DeviceStateEntity">DeviceStateEntity.</param>
        /// <param name="SerialNumber">SerialNumber.</param>
        public CreateDeviceDTO(string DeviceDescription = null, DeviceStateEntityEnum? DeviceStateEntity = null, string SerialNumber = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CreateDeviceDTO);
        }

        /// <summary>
        /// Returns true if CreateDeviceDTO instances are equal
        /// </summary>
        /// <param name="other">Instance of CreateDeviceDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateDeviceDTO other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
