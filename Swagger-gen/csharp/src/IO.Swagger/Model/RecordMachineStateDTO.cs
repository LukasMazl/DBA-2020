...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RecordMachineStateDTO :  IEquatable<RecordMachineStateDTO>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RecordMachineStateDTO" /> class.
        /// </summary>
        ...
        /// <param name="Tensomert">Tensomert.</param>
        /// <param name="Tensometer">Tensometer.</param>
        /// <param name="Vin">Vin.</param>
        public RecordMachineStateDTO(string Action = null, double? GpsX = null, double? GpsY = null, double? Humidity = null, double? RestOfFuel = null, string SerialNumber = null, double? SpeedX = null, double? SpeedY = null, double? SpeedZ = null, double? StreesBattery = null, double? Tensomert = null, double? Tensometer = null, string Vin = null)
        {
            this.Action = Action;
            this.GpsX = GpsX;
            this.GpsY = GpsY;
        ...
        /// <summary>
        /// Gets or Sets Tensomert
        /// </summary>
        [DataMember(Name="tensomert", EmitDefaultValue=false)]
        public double? Tensomert { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  Tensomert: ").Append(Tensomert).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RecordMachineStateDTO);
        }

        /// <summary>
        /// Returns true if RecordMachineStateDTO instances are equal
        /// </summary>
        /// <param name="other">Instance of RecordMachineStateDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecordMachineStateDTO other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.Tensomert == other.Tensomert ||
                    this.Tensomert != null &&
                    this.Tensomert.Equals(other.Tensomert)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Tensomert != null)
                    hash = hash * 59 + this.Tensomert.GetHashCode();
